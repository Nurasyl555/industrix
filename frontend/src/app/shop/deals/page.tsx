    ...
    >
      <div className="min-w-0">
        <div className="mb-1 flex items-center gap-2">
          ...
          <span className={`rounded px-2 py-0.5 text-[10px] font-bold uppercase ${deal.status === "closed" ? "bg-gray-100 text-gray-500" : "bg-amber-100 text-amber-700"}`}>
            {deal.status}
          </span>
        </div>
        <p className="truncate text-sm text-gray-700">
          {deal.message || <span className="text-gray-400">No message</span>}
        </p>
      </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-6 py-8">
        <h1 className="mb-6 text-2xl font-extrabold text-gray-900">My Deals</h1>
